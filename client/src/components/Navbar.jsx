...
const Navbar = () => {
    ...
    //useContext is used to access the context values from AppContext.jsx
    const location = useLocation()
    const [open, setOpen] = useState(false) //by default menu will be closed in smaller screen
    const navigate=useNavigate()
   //when dashboard is clicked it will navigate to the owner page
